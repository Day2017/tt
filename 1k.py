...
cl = LINETCR.LINE()
cl.login(token="Eq9mizbFhJdPLCKJuzja.o2v/wBPF25jqkFF63SIp/G.628mgebOOuniIDAnBeaciMa8DMyi3MHlrAoWtXWjp6A=")
cl.loginResult()
...
╔•═•••⊰✴⊱•⊰✴⊱•✴⊱•••═•╗รับติดตั้งบอทราคามิตรภาพ..จิ้มลิ้งมานะแจ๊ะ
ⒷⓄⓉ➣ѕєʟғ➣TIGER69
http://line.me/ti/p/~yiger69a
 ไม่อ่าน โทรมานะครับติดต่อที่
   ⊰✴⊱0830404140⊰✴⊱
╚•═•••⊰✴•⊰✴⊱•✴⊱•••═•╝
🇹 🇮⃢🇬 🇪 🇷⑥⑨☪☪➤➤┅┅┅┅┅┅┅
...
╚═══════════════
╔════════════════
║เชคการตั้งค่าข้อความคนลบคนเข้าคนออก 
╠════════════════
...
targets = []
mid = cl.getProfile().mid
Bots = ["u3b657e59ba5fdb925029f7fadec88ffa",mid]
self = ["u3b657e59ba5fdb925029f7fadec88ffa",mid]
admin = "u3b657e59ba5fdb925029f7fadec88ffa"
admsa = "u3b657e59ba5fdb925029f7fadec88ffa"
owner = "u3b657e59ba5fdb925029f7fadec88ffa"
adminMID = "u3b657e59ba5fdb925029f7fadec88ffa"
Creator="u3b657e59ba5fdb925029f7fadec88ffa"
wait = {
    "alwayRead":False,
    "detectMention":True,    
    "kickMention":False,
    ...
    'message':"Thanks for add Me By:🇹 🇮⃢🇬 🇪 🇷⑥⑨☪☪➤",
    "lang":"JP",
    "comment":"AutoLike by TIGER69",
    "commentOn":False,
    "acommentOn":False,
    "bcommentOn":False,
    "ccommentOn":False,
...
#----------------------------------------------------------------------------
                ...
                msg.contentType = 13
                adm = 'u3b657e59ba5fdb925029f7fadec88ffa'
                msg.contentMetadata = {'mid': adm}
                cl.sendMessage(msg)
                cl.sendText(msg.to,"Add Line https://line.me/ti/p/~yiger69a")
...
#==================================================
                ...
                cl.sendText(msg.to,"""[ⒷⓄⓉ➣ѕєʟғ➣TIGER69🇹🇭 ]\n\n
คำสั่งบอท siri
...
#=============================================
                ...
                cl.sendText(msg.to,"ⒷⓄⓉ➣เปิดแทคแล้ว➣")
                ...
                cl.sendText(msg.to,"ⒷⓄⓉ➣เปิดแตะแล้ว➣")
                
            elif msg.text in ["ปิดเตะแทค"]:
                wait["kickMention"] = False
                cl.sendText(msg.to,"ⒷⓄⓉ➣ปิดแตะแทคสำเสร็จแล้ว")
        ...
        if op.type == 26:
            ...
            if msg.text.lower() in ["1123"]:
                ...
                cl.sendMessage(cnt)
                        ...
                        cl.sendText(msg.to,"􀼂􀅝church􏿿􀼂􀅜arbor􏿿﹏􀼂􀅞limo 1􏿿􀼂􀅟limo 2􏿿􀼂􀅠limo 3􏿿﹏􀼂􀅜arbor􏿿􀼂􀅝church􏿿กลัวหลุดหราเชคจัง แบร่ๆ")       
            elif "." == msg.text.lower():
                if msg.to in wait2['readPoint']:
                        try:
                            del wait2['readPoint'][msg.to]
                        ...
                        with open('sider.json', 'w') as fp:
                         json.dump(wait2, fp, sort_keys=True, indent=4)
                         cl.sendText(msg.to,"Lurking already on\nเปิดการอ่านอัตโนมัตกรุณาพิมพ์ ➠􀼂􀅝church􏿿􀼂􀅜arbor􏿿﹏􀼂􀅞limo 1􏿿􀼂􀅟limo 2􏿿􀼂􀅠limo 3􏿿﹏􀼂􀅜arbor􏿿􀼂􀅝church􏿿")
                else:
                    try:
                            del wait2['readPoint'][msg.to]
                            del wait2['readMember'][msg.to]
